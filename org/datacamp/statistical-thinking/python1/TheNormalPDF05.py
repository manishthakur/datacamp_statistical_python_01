...
# Plot a histogram of each of the samples; for each, use 100 bins, also using the keyword arguments density=True and histtype='step'.
# The latter keyword argument makes the plot look much like the smooth theoretical PDF. You will need to make 3 plt.hist() calls.

# Hit submit to make a legend, showing which standard deviations you used, and show your plot!
# There is no need to label the axes because we have not defined what is being described by the Normal distribution;
# we are just looking at shapes of PDFs.
